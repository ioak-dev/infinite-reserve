...
const SearchPage = (props: Props) => {
  ...
  useEffect(() => {
    const _searchConfig = getSessionValueAsJson('infinitereserve-searchconfig-browse');
  ...
  const handleSearch = (_searchConfig?: SearchConfigType) => {
    ...
    setSessionValueAsJson('infinitereserve-searchconfig-browse', _searchConfigCurrent);
