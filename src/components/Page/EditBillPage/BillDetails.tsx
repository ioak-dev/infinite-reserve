...
import { INFINITERESERVE_PREF_ADDBILL_DATE } from '../../../constants/SessionStorageConstants';
...
const BillDetails = (props: Props) => {
  const handleChange = (event: any) => {
    ...
    if (event.currentTarget.name === 'billDate') {
      sessionStorage.setItem(INFINITERESERVE_PREF_ADDBILL_DATE, event.currentTarget.value);
    }
  };
