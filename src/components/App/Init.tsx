...
const Init = () => {
  ...
  const initializeProfileFromSession = () => {
    const colorMode = sessionStorage.getItem('infinitereserve_pref_profile_colormode');
    const sidebarStatus = sessionStorage.getItem('infinitereserve_pref_sidebar_status');
